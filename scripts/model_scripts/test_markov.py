...
def test_markov_node_probability_range():
    node = MarkovNode(state=1, probability=0.4)
...
def test_markov_chain_valid_row_sum():
    row = [
        MarkovNode(state=1, probability=0.5),
        MarkovNode(state=2, probability=0.5)
    ]
...
def test_markov_chain_is_square_matrix():
    row1 = [MarkovNode(1, 0.5), MarkovNode(2, 0.5)]
    row2 = [MarkovNode(1, 0.5), MarkovNode(2, 0.5)]
...
def test_markov_chain_state_transition():
    node11 = MarkovNode(1, 0.6)
    node12 = MarkovNode(2, 0.4)
    node21 = MarkovNode(1, 0.3)
    node22 = MarkovNode(2, 0.7)
